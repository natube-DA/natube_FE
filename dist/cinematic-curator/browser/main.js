...
var environment = {
  production: true,
  apiBaseUrl: "https://api.cinematic-curator.example"
};

// src/app/core/interceptors/api-base-url.interceptor.ts
var apiBaseUrlInterceptor = (request, next) => {
  const isAbsoluteUrl = /^https?:\/\//i.test(request.url);
  const isAssetRequest = request.url.startsWith("/assets/") || request.url.startsWith("./assets/") || request.url.startsWith("assets/");
...
var authInterceptor = (request, next) => {
  ...
  if (!accessToken || !request.url.startsWith(environment.apiBaseUrl)) {
    return next(request);
  }
  return next(request.clone({
    setHeaders: {
...
function initializeLanguage(languageService) {
...
function AuthModalComponent_Conditional_0_Conditional_28_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("formGroup", ctx_r1.signInForm);
    \u0275\u0275advance(5);
...
function AuthModalComponent_Conditional_0_Conditional_29_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275conditional(ctx_r1.signUpForm.controls.displayName.invalid && ctx_r1.signUpForm.controls.displayName.touched ? 5 : -1);
    \u0275\u0275advance(5);
...
function AuthModalComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275listener("click", function AuthModalComponent_Conditional_0_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.close());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(1, "section", 1)(2, "button", 2);
    \u0275\u0275listener("click", function AuthModalComponent_Conditional_0_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.close());
    });
    ...
    \u0275\u0275listener("click", function AuthModalComponent_Conditional_0_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.switchMode("signin"));
    });
    \u0275\u0275text(13, " Sign in ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "button", 8);
    \u0275\u0275listener("click", function AuthModalComponent_Conditional_0_Template_button_click_14_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.switchMode("signup"));
    });
    \u0275\u0275text(15, " Register ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 9)(17, "button", 10);
    \u0275\u0275listener("click", function AuthModalComponent_Conditional_0_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.continueWithGoogle());
    });
    \u0275\u0275elementStart(18, "span", 11);
    \u0275\u0275text(19, "public");
    \u0275\u0275elementEnd();
    \u0275\u0275text(20, " Continue with Google ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "button", 10);
    \u0275\u0275listener("click", function AuthModalComponent_Conditional_0_Template_button_click_21_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.continueWithApple());
    });
    \u0275\u0275elementStart(22, "span", 11);
    \u0275\u0275text(23, "phone_iphone");
    \u0275\u0275elementEnd();
    \u0275\u0275text(24, " Continue with Apple ");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx_r1.modal.state().title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.modal.state().description);
    \u0275\u0275advance(2);
...
_AuthModalComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuthModalComponent, selectors: [["app-auth-modal"]], hostBindings: function AuthModalComponent_HostBindings(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275listener("keydown.escape", function AuthModalComponent_keydown_escape_HostBindingHandler() {
      return ctx.onEscape();
    }, \u0275\u0275resolveDocument);
  }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AuthModalComponent, [{
    type: Component,
    args: [{ selector: "app-auth-modal", standalone: true, imports: [ReactiveFormsModule], changeDetection: ChangeDetectionStrategy.OnPush, template: `@if (modal.state().isOpen) {
  <div class="auth-modal-backdrop" (click)="close()"></div>

  <section
    class="auth-modal surface-card"
    role="dialog"
    aria-modal="true"
    aria-labelledby="auth-modal-title"
    aria-describedby="auth-modal-description">
    <button type="button" class="auth-modal__close icon-button" aria-label="Close auth modal" (click)="close()">
      <span class="material-symbols-outlined">close</span>
    </button>

    <p class="auth-modal__eyebrow text-label">Account access</p>
    <h2 id="auth-modal-title" class="page-title auth-modal__title">{{ modal.state().title }}</h2>
    <p id="auth-modal-description" class="auth-modal__description">{{ modal.state().description }}</p>

    <div class="auth-modal__tabs" aria-label="Authentication mode">
      <button
        type="button"
        class="auth-modal__tab"
        [class.auth-modal__tab--active]="modal.state().mode === 'signin'"
      ...
      <button
        type="button"
        class="auth-modal__tab"
        [class.auth-modal__tab--active]="modal.state().mode === 'signup'"
    ...
    <div class="auth-modal__socials">
      <button type="button" class="auth-modal__social-button" (click)="continueWithGoogle()">
        <span class="material-symbols-outlined" aria-hidden="true">public</span>
        Continue with Google
      </button>

      <button type="button" class="auth-modal__social-button" (click)="continueWithApple()">
        <span class="material-symbols-outlined" aria-hidden="true">phone_iphone</span>
        Continue with Apple
      </button>
    </div>

    <div class="auth-modal__divider" aria-hidden="true">
